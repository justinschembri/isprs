...
class TestBSSA13GMPE(unittest.TestCase):
    ...
    def test_site_term_pga_r_and_nonlinear_component_calculation(self) -> None:
        ...
        #check the non-linear component, which should evaluate to almost 0.
        self.assertAlmostEqual(self.gmpe.site_term._calculate_nonlinear_component(), 0.00, 2)
